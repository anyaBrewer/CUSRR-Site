...
// (function () {
//   // Helper: read data-* from a card and fill the modal
...
//   // Click handler (prevents dropdown clicks from triggering)
//   function cardClickHandler(e) {
//     // Ignore clicks that originate inside a dropdown, button, or link.
//     const ignore = e.target.closest('.dropdown, [data-bs-toggle="dropdown"], button, a');
//     if (ignore) return;
...
//   // Also support cards added later inside #upcoming-container (event delegation)
//   const container = document.getElementById('upcoming-container');
//   if (container) {
...
//       // Don’t open if clicking the dropdown or links inside the card
